...
Page({
  data: {
    ...
    article: {
      ...
      copyright: "翻译",
      published_at: "2天前",
      content: "用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验用神经网络向我比心: 有个当算法工程师的女朋友是这样一种体验",
      related_nodes: [
        {
